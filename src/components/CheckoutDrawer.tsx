...
import { buscarCep, freteGratis, onlyDigits } from "@/lib/frete";
      ...
      >
        <div className="flex items-center justify-between p-5 border-b border-white/10">
          <div className="flex items-center gap-2">
            {step > 1 && (
              <button onClick={() => setStep(1)} className="p-1 hover:bg-white/5 rounded-full">
                <ChevronLeft className="size-5" />
              </button>
            )}
            <h2 className="text-lg font-display font-bold">
              {step === 1 ? "Endereço" : "Confirmar"}
            </h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-4">
          {step === 1 && (
            <>
              ...
              <p className="text-xs text-brand font-medium pt-1">Entrega grátis em todo o Brasil.</p>
            </>
          )}
          ...
          {step === 2 && (
            <>
              <div className="bg-white/5 rounded-xl p-4 space-y-2 text-sm">
                ...
                <p className="text-xs text-brand font-medium pt-1">Frete grátis</p>
              </div>
        ...
        <div className="border-t border-white/10 p-5">
          {step === 1 && (
            <button onClick={irParaConfirmar} className="w-full bg-brand text-primary-foreground rounded-full py-3.5 font-bold uppercase tracking-tight text-sm hover:scale-[1.02] transition-transform">
              Continuar
            </button>
          )}
          {step === 2 && (
